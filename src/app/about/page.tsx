...
export default function About() {
  return (
    <section className="flex min-h-screen flex-col items-center pt-20 gap-10 max-lg:pb-40">
      <FadeText
      ...
      <div className="w-[700px] max-md:w-full text-justify text-[#dbdbdb] flex flex-col gap-5">
        <FadeText
          className="text-xl"
          direction="left"
          framerProps={{
